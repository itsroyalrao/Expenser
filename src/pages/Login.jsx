    ...
    <div className="w-full h-[100dvh] flex items-center justify-center bg-[#202020]">
      <div className="w-full h-full flex flex-col items-center justify-center bg-white py-[10%] space-y-6">
        ...
        <div className="w-[80%] flex flex-col">
          ...
          />
          <div className="w-full bg-blue-600 flex justify-center py-2 rounded-lg text-white text-xl mt-4">
            Login
          </div>
        </div>

        <div className="text-lg">
          Don&apos;t you have an account? <Link className="font-bold text-green-600">Signup </Link>
        </div>

        <hr className="w-[90%] border-t-2 border-gray-300" />

        <div className="text-xl">Or Login with</div>
